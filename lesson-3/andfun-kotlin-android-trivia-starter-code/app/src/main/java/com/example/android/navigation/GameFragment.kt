...
class GameFragment : Fragment() {
    ...
    // The first answer is the correct one.  We randomize the answers before showing
    // the text.
    // All questions must have four answers.  We'd want these to contain references to
    // string
    // resources so we could internationalize. (or better yet, not define the questions
    // in code...)
    ...
    // Sets the question and randomizes the answers.  This only changes the data, not
    // the UI.
